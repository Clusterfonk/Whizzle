...
Lost::Lost(State_manager& s_m, sf::RenderWindow& window, int winner_score, bool replace) :
    ...
    winner_score(std::to_string(winner_score), sf::Vector2f(648.0f, 328.0f), 14, Label::Align::TOP) {
        bg_texture = Resource_manager::get_texture("../assets/you_lose.png");
...
void Lost::update(const sf::Time& delta_time) {
    sf::Event event;
